	...
	<div class="col-md-8" style="margin-top:25px;">
		<div class="card">
			<div class="card-header">
				Form Bongkar Pasang Ac
			</div>
			<div class="card-body">
				<form action="{{ route('bb') }}" method="POST" autocomplete="off">
					@csrf
					...
					<h3>Info Bongkar Pasang AC</h3>
					<hr>
					<h4>Beritahu kami masalah Anda</h4>
					<div class="form-group">
						<label class="checkbox-inline">
							<input type="radio" name="info" id="jps" value="Jasa Pemasangan"> Jasa Pemasangan
						</label>
						<label class="checkbox-inline">
							<input type="radio" name="info" id="jpb" value="Jasa Pembongkaran"> Jasa Pembongkaran
						</label>
					</div>

					<h4>Jumlah Unit AC</h4>
					<div class="form-group">
						<input type="text" name="jml" id="jml" onkeyup="bongprice()" class="form-control" required="required">
					</div>
					...
					<div class="form-group">
						...
						<h4>Tanggal</h4>
						<div class="form-group">
							<input type="date" name="tgl" min="{{ date('Y-m-d')}}" class="form-control" required="required">
						</div>
						<h4>Waktu</h4>
					<!-- 	<div class="form-group">
		...
		<div class="col-md-4 col-xs-12 float-right" style="margin-top:25px; margin-bottom: 25px">
			<div class="card">
				...
				<div class="card-body">
					<center><img src="{{ URL::asset('siac_img/bongkar-pasang.jpg')}}" style="width: 100%; height: auto"></center>
				</div>
			</div>
