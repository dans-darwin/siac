...
<div class="row" style="margin: 85px">
	<div class="col-md-8" style="margin-top:25px;">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('bs') }}" method="POST" autocomplete="off">
					@csrf
					...
					<h3>Info Reparasi AC</h3>
					<hr>
					<h4>Beritahu kami masalah Anda</h4>
					<div class="form-group">
						<label class="checkbox-inline">
							<input type="checkbox" name="info[]" value="Tidak Menyala"> Tidak menyala
						</label>
						<label class="checkbox-inline">
							<input type="checkbox" name="info[]" value="Masalah Perkabelan"> Masalah perkabelan
						</label>
						<label class="checkbox-inline">
							<input type="checkbox" name="info[]" value="Bocor Air"> Bocor Air
						</label>
						<label class="checkbox-inline">
							<input type="checkbox" name="info[]" value="Berisik"> Berisik
						</label>
						<label class="checkbox-inline">
							<input type="checkbox" name="info[]" value="Masalah Pipa"> Masalah pipa
						</label>
						<label class="checkbox-inline">
							<input type="checkbox" name="info[]" value="AC Tidak Dingin"> AC Tidak Dingin
						</label>
					</div>

					<h4>Jumlah Unit AC</h4>
					<div class="form-group">
						<input type="text" name="jml" id="jml" onkeyup="repprice()" class="form-control" required="required">
					</div>
					...
					<h4>Berapa PK AC Anda ?</h4>
					<div class="form-group">
						<div class="radio">
							<label><input type="radio" name="jenis_pk" value="< 1 PK"> dibawah 1 PK</label>
							</div>
							<div class="radio">
								<label><input type="radio" name="jenis_pk" value=">= 1 PK"> 1 PK - 2 PK</label>
							</div>
						</div>
						...
						<h4>Tanggal</h4>
						<div class="form-group">
							<input type="date" name="tgl" id="tgl" min="{{ date('Y-m-d')}}" class="form-control" required="required">
						</div>
						<h4>Waktu</h4>
						<!-- <div class="form-group">
						...
						<div class="form-group">
							<select class="form-control" name="waktu">
								...
								<option value="{{date('H:00', mktime($time+1))}}">{{date('H:00', mktime($time+1))}}</option>
								@endforeach
							</select>
						</div>
						<hr>
		...
		<div class="col-md-4 col-xs-12 float-right" style="margin-top:25px; margin-bottom: 25px">
			<div class="card">
				...
				<div class="card-body">
					<center><img src="{{ URL::asset('siac_img/service.jpg')}}" style="width: 100%; height: auto"></center>
				</div>
			</div>
